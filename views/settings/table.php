...
$config = [
	'per_page'		=> 5,
	'columns'		=> [
		'id'				=> __( 'Order #', 'user-switcher' ),
		'products'			=> __( 'Products', 'user-switcher' ),
		'order_total'		=> __( 'Order Total', 'user-switcher' ),
		'commission'		=> __( 'Commission', 'user-switcher' ),
		'payment_status'	=> __( 'Payment Status', 'user-switcher' ),
		'time'				=> __( 'Time', 'user-switcher' ),
	],
	...
	'bulk_actions'	=> [
		'delete'	=> __( 'Delete', 'user-switcher' ),
		'draft'		=> __( 'Draft', 'user-switcher' ),
	],
];
